...
export const PaletteIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 21a4 4 0 01-4-4 7 7 0 0114 0 4 4 0 01-4 4 4 4 0 01-4-4h-2a4 4 0 01-4 4zm8-13a1 1 0 11-2 0 1 1 0 012 0zm-4-1a1 1 0 11-2 0 1 1 0 012 0zm-4 3a1 1 0 11-2 0 1 1 0 012 0z" />
  </svg>
);
...
export const ArtIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
